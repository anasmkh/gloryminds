...
import fitz  # PyMuPDF, comes bundled with pymupdf4llm
import pymupdf4llm
...
def convert_all(input_dir: Path, output_dir: Path, only: list[str] | None = None) -> None:
    if only:
...
if __name__ == "__main__":
    ...
    convert_all(input_dir, output_dir, only=args.only)